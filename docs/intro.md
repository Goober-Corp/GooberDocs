...
title: Intro
date: 2026-05-21
description: A general intro to GooberLib
authors:
  - kr1v
  - tektonikal
draft: false
...
GooberLib provides the basic set of options such as primitives, `String`s and lists. GooberLib uses a more novel approach to expressing configurations, using a mix of both builders and special config classes (think MaLiLib). However, builders do not mean that you need to write an ungodly amount of code for a simple config, as GooberLib offers solutions for that.
...
<p style="text-align: center;"><em>Our mascot, Kenny, in the background.</em></p>
