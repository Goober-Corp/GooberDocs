...
title: User Guide
date: 2026-06-12
description: Tips and tricks for power users (and clueless folks)
authors:
  - tektonikal
draft: false
comments: false
...
## Features and tricks for efficiently navigating GooberLib screens.

- You can drag (left click) anywhere onscreen to scroll, if you want to do that for some reason?
- More importantly, you can drag with your middle mouse button to drag at 5X speed if you want to get somewhere faster.
- You can reset options by middle-clicking them. (TODO: implement)
